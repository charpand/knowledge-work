...
4. **Open Questions**: Issues raised but not resolved (with assigned owner for follow-up if applicable)
5. **Risks or Concerns Raised**: Issues identified but not yet addressed by decision
6. **Next Scheduled Touchpoint**: When this work will be reviewed or next decision point

Format: Email-ready or shared document format, concise (under 1,000 words).
...
- [ ] No inferred decisions; ambiguities flagged explicitly
- [ ] Open questions include assigned owner for resolution
- [ ] Summary can be read independently without access to original notes
- [ ] Participant language is accurate; technical terms verified
